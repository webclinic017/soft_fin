...
def serve():
    ...
    regular_adjustment_pb2_grpc.add_RegularAdjustmentServicer_to_server(RegularAdjustmentService(), server)
    conditional_trigger_pb2_grpc.add_ConditionalTriggerServicer_to_server(ConditionalTriggerService(), server)
    adjustment_and_triggering_of_portfolio_pb2_grpc.add_AdjustmentAndTriggeringOfPortfolioServicer_to_server(
        AdjustmentAndTriggeringOfPortfolioService(), server)

...
def retrain_delta_model(protfolio_id,asset_id,asset_mount,cash,options,test):
    return backtest.options.retrain_delta_model(protfolio_id,asset_id,asset_mount,cash,options,test)

def retrain_gamma_model(protfolio_id,asset_id,asset_mount,cash,options1,options2,test):
    return backtest.options.retrain_gamma_model(protfolio_id,asset_id,asset_mount,cash,options1,options2,test)

def fit_delta(protfolio_id,asset_id,asset_mount,cash,options,begin_t,end_t,test):
    return backtest.options.fit_delta(protfolio_id,asset_id,asset_mount,cash,options,begin_t,end_t,test)

def fit_gamma(protfolio_id,asset_id,asset_mount,cash,options1,options2,begin_t,end_t,test):
    return backtest.options.fit_gamma(protfolio_id,asset_id,asset_mount,cash,options1,options2,begin_t,end_t,test)
